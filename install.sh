...
# Base URL baked into the results-screen QR code. Default to this domain.
...
# Generate runtime config (QR base URL) from deploy.config.
log "Writing runtime config (QR base URL: ${QR_BASE_URL})"
cat > "${INSTALL_DIR}/config.js" <<EOF
// Generated by install.sh from deploy.config — do not edit by hand.
